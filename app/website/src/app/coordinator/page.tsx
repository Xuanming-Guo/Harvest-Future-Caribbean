...
export default function CoordinatorHome() {
  ...
  return (
    <>
      <div data-tour="coordinator-home"><PageHeader eyebrow="Coordination tasks" title="Coordination" /></div>
      ...
      <div className="dashboard-grid">
        ...
        <Card data-tour="coordinator-verification">
          ...
          {!verification.data.items.length ? <EmptyState title="Crop updates are verified" /> : <div className="task-list">{verification.data.items.map((task) => (
      ...
      <Card className="section-gap" data-tour="coordinator-exceptions">
        ...
        {!openExceptions.length ? <EmptyState title="No active exceptions" /> : <div className="exception-list">{openExceptions.map((exception) => (
