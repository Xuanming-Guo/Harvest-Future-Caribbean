...
| `RECOVERY_APPROVED` | A human approves a recovery proposal | exception, approval, action | Deterministically reroute, reschedule, substitute, reallocate, or cancel future work |
| `DELIVERY_ACCEPTED` | Buyer records accepted and rejected quantities | delivery, order, quantities, outcome | Record actual outcome and economics for model/benchmark evaluation |
